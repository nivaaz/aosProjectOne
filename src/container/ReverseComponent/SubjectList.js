...
export class SubjectList extends Component {  
   ...
   subjectsNeeded (){ 
    ...
    if (needed > 0){ //you need to add subs
       return ( 
           <div className = "info">
                   You need to add {needed} more units to estimate subject marks.
                   <p>
                    Your Scaled & HSC marks will automatically update when you add enough units.
                </p>
           </div>
           );           
       }
